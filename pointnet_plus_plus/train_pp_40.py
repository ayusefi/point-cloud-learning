...
def parse_args():
    ...
    parser.add_argument('--data_path', type=str, default='../data/ModelNet40', help='Path to ModelNet10 dataset')
...
def train():
    ...
    # Note: Assuming your ModelNet40Dataset can accept augmentation parameters
    # If not, you'll need to modify the dataset class accordingly
    train_ds = ModelNet40Dataset(args.data_path, 'train', num_points, augment=args.augmentation != 'none', **aug_params)
    val_ds   = ModelNet40Dataset(args.data_path, 'test',  num_points, augment=False)
    test_ds  = ModelNet40Dataset(args.data_path, 'test',  num_points, augment=False)
